...
public class UICraftingSystems : MonoBehaviour
{
    ...
    private CraftingSystem1 craftingSystem;
    ...
    private void Awake()
    {
        ...
        slotTransformArray = new Transform[CraftingSystem1.GRID_SIZE, CraftingSystem1.GRID_SIZE];

        for (int x = 0; x < CraftingSystem1.GRID_SIZE; x++)
        {
            for (int y = 0; y < CraftingSystem1.GRID_SIZE; y++)
            {
      ...
      public void SetCraftingSystem(CraftingSystem1 craftingSystem)
      {
